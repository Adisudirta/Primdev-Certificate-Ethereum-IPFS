	...
	<div class="container">
		<Breadcrumb.Root class="my-8">
			<Breadcrumb.List>
				...
				<Breadcrumb.Item>
					<Breadcrumb.Page class="text-teal-500">PDXGDSC01</Breadcrumb.Page>
				</Breadcrumb.Item>
			</Breadcrumb.List>
		</Breadcrumb.Root>
		...
		<div class="mb-8 flex items-center justify-between">
			<div class="flex flex-col space-y-4">
				<h1 class=" text-3xl font-bold text-primary">Primdev X GDSC Event</h1>
				<div class="flex items-center space-x-3">
					<div class="rounded-lg bg-teal-500 px-1 py-0.5">
						<span class="text-[11px] font-semibold text-white">PDXGDSC01</span>
					</div>
					<span class="text-gray-500">|</span>
					<p class="font-semibold text-gray-500">19 Mei 2024</p>
				</div>
			</div>
